	    	   			...
	    	   			<div class="pillar">
							...
							<div class="boxcontent" style="min-height:856px">
									...
									<div class="systemmanagecontent">
									 ...
									 <s:iterator value="smnlist">
									    <span style="margin-top:10px;margin-left: 30px;width: auto;display: block;">
										    <img src="images/point.gif" style="vertical-align: baseline;width: 12px;margin-right: 4px"/><a href="manageinfolab?infoid=<s:property value='id'/>" target="blank"><s:property value='title'/></a>	
										</span>
									 </s:iterator>
