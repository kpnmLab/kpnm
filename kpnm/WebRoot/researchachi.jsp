							...
							<div class="boxcontent" style="min-height:856px">
									...
									<table class="biaoti">
										<tr>
											...
											<td style="width:35%">项目获奖及鉴定情况</td>
											<td style="width: 30%">获奖名称</td>
											<td style="width: 15%">时间</td>
										</tr>
									</table>
									
									<form id="searchform" action="researchachi" method="post">
									...
									<table class="items"  style="border: none" >
										<s:iterator value="kyzxlist">
											<tr>
												<td style="width: 20%"><s:property value="person" escape="false"/></td>
												<td style="width:35%"><s:property value="title" escape="false"/></td>
												<td style="width: 30%"><s:property value="publication" escape="false"/></td>
												<td style="width: 15%"><s:property value="date" escape="false"/></td>
											</tr>
