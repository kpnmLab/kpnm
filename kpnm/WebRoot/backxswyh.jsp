   ...
   <div class="m-right">
			<div class="right-nav">
				<ul>
					...
					<li>></li>
					<li><a href="javascript:(0)">学术委员会</a>
					</li>
				</ul>
			</div>
	      ...
	      $(function()
	      {
		      ...
		      $("#zwbbxg").click(function()
			  {
				  ...
				  $.ajax({  
				            url: 'updatelc',  
				            type: 'post',  
				            data: {updateinfoid:131,language:'ch',content:contentch},  
			  ...
			  $("#ywbbxg").click(function()
			  {
				  ...
				  $.ajax({  
				            url: 'updatelc',  
				            type: 'post',  
				            data: {updateinfoid:131,language:'en',content:contenten},  
				            success: function(data)
				            {
			            		if(data.updateresult == 'ok')
				            	{
