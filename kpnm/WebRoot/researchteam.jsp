...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="css/researchteam.css">
	    	   		...
	    	   		<div class="up">
	    	   			...
	    	   			<div class="pillar">
							...
							<div class="boxcontent" style="min-height:856px">
									...
									<s:iterator value="ltlist" status="LT">
											<div class="researchteam">
											 <!-- 具体内容-->
											 	<div class="menname">
											 		<a href="teacherhometeam?teacherid=<s:property value='id'/>"><s:property value="title"/>&nbsp;<s:property value="name"/></a>
											 	</div>
											 	<div class="menpicture">
											 		<a href="teacherhometeam?teacherid=<s:property value='id'/>"><img class="menimg" src="./<s:property value='photo'/>"/></a>
											 	</div>
											 	<div class="fenge"></div>
											 	<div class="menintroduce">
											 		<p><s:property value="%{introduce}" escape="false"/></p>
											 	</div>
											</div>	
									</s:iterator>
