   ...
   <div class="m-right">
			<div class="right-nav">
				<ul>
					...
					<li><a href="javascript:(0)">科学研究</a>
					</li>
					<li>></li>
					<li><a href="javascript:(0)">研究方向</a>
					</li>
				</ul>
			</div>
	      ...
	      $(function()
	      {
		      ...
		      $("#zwbbxg").click(function()
			  {
				  ...
				  $.ajax({  
				            url: 'updatelc',  
				            type: 'post',  
				            data: {updateinfoid:130,language:'ch',content:contentch},  
			  ...
			  $("#ywbbxg").click(function()
			  {
				  ...
				  $.ajax({  
				            url: 'updatelc',  
				            type: 'post',  
				            data: {updateinfoid:130,language:'en',content:contenten},  
				            success: function(data)
				            {
			            		if(data.updateresult == 'ok')
				            	{
