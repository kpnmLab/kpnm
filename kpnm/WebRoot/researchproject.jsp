							...
							<div class="boxcontent" style="min-height:856px">
									...
									<table class="biaoti">
										<tr>
											...
											<td style="width: 30%">项目来源</td>
											<td style="width: 25%">起止时间</td>
										</tr>
									</table>
									
									<form id="searchform" action="projectsr" method="post">
									...
									<table class="items">
										<s:iterator value="projectlist">
											<tr>
												<td style="width: 30%"><s:property value="name" escape="false"/></td>
												<td style="width:15%"><s:property value="leadername" escape="false"/></td>
												<td style="width: 30%"><s:property value="from" escape="false"/></td>
												<td style="width: 25%"><s:property value="date" escape="false"/></td>
											</tr>
