...
<html>
  ...
  <body>
   <div class="m-right">
					...
					<div id="chinese">
							...
							<div class="titlepser">
								<div  class="t">
									...
									<input id="titlech" type="text" name="titlech" value="" placeholder="请输入制度标题"/>
								</div>
							</div>
							 <section id="editor">
					...
					<div id="english">
						...
						<div class="titlepser">
								<div class="t">
									...
									<input id="titleen" type="text" name="titleen" value="" placeholder="input the system title here"/>
								</div>
							</div>
						<section id="editoren">
		...
		<form id="chnform" action="csystemlab" method="post">
