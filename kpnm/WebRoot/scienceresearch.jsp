	    	   		...
	    	   		<div class="up">
	    	   			...
	    	   			<div class="pillar">
							...
							<div class="boxcontent">
									...
									<div class="newstitle">
										 <p>
										 	<s:property value="lse.title" escape="false"/>
										 </p>
										<div>
											更新时间：<s:property value="%{lse.updatedate.toString().substring(0,10)}" escape="false"/>
										</div>
									</div>
									<div class="newscontent">
									 <!-- escape="false"  保证html标签正常输出 -->
									 <!-- 具体内容-->
									 <s:property value="lse.content" escape="false"/>
