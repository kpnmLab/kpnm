   ...
   <div class="m-right">
			<div class="right-nav">
				<ul>
					...
					<li>></li>
					<li><a href="javascript:(0)">开放基金</a>
					</li>
				</ul>
			</div>
			<div class="main" align="center">
				<div class="sysjj">
					<img id="jbxximg" src="images/kfjj.png">
					<span class="s2">开放基金</span>
	      ...
	      $(function()
	      {
		      ...
		      $("#zwbbxg").click(function()
			  {
				  ...
				  $.ajax({  
				            url: 'updatelc',  
				            type: 'post',  
				            data: {updateinfoid:139,language:'ch',content:contentch},  
			  ...
			  $("#ywbbxg").click(function()
			  {
				  ...
				  $.ajax({  
				            url: 'updatelc',  
				            type: 'post',  
				            data: {updateinfoid:139,language:'en',content:contenten},  
				            success: function(data)
				            {
			            		if(data.updateresult == 'ok')
				            	{
